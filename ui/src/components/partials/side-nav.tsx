...
const menuItems = [
    {
        title: "Navigation",
        items: [
            { to: "/tablero", label: "Dashboard", icon: <Users className="w-4 h-4" /> },
            { to: "/pacientes", label: "All Patients", icon: <Users className="w-4 h-4" /> },
            { to: "/paciente/nuevo", label: "New Patient", icon: <Users className="w-4 h-4" /> },
        ]
    }
];
                ...
                <>
                    ...
                    >
                        <div className='flex items-center justify-between h-[80px] px-4 border-b dark:border-b-gray-800'>
                            ...
                            >
                                <Text className='text-xl font-bold text-primary' label='Clínica Médica' />
                            </motion.div>
